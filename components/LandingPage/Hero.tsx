  ...
  return (
    <header className="hero-section">
      <motion.div
        ...
        animate="visible"
      >
        <motion.p className="collective-tag" variants={textVariants}>
          THE COLLECTIVE
        </motion.p>
        <motion.h1 className="hero-title" variants={textVariants}>
          We are the<span className="ignition-point">&nbsp; Ignition Point</span>
          <br />
          for the impossible.
        </motion.h1>
        <motion.p className="hero-subtitle" variants={textVariants}>
          GM Studios is not just a network, it is a sanctuary for the
          obsessed. Unite fragmented communities into a singular, high-trust
          force designed to turn &quot;what if&quot; into &quot;what
          is&quot;
        </motion.p>
